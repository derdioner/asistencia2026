...
async function startMassRobot() {
    ...
    try {
        ...
        // Check list availability (using global currentCommList from script.js)
        if (typeof currentCommList === 'undefined' || !currentCommList || currentCommList.length === 0) {
